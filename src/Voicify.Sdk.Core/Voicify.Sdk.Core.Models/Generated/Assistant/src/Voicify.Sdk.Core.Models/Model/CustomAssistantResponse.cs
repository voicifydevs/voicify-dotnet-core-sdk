...
{
    /// <summary>
    /// CustomAssistantResponse
    /// </summary>
    [DataContract]
    public partial class CustomAssistantResponse :  IEquatable<CustomAssistantResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomAssistantResponse" /> class.
        /// </summary>
        ...
        public List<CustomAssistantListItem> ListItems { get; set; }

        /// <summary>
        /// Gets or Sets EndSession
        /// </summary>
        [DataMember(Name="endSession", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomAssistantResponse {\n");
        ...
        {
            return this.Equals(input as CustomAssistantResponse);
        }

        /// <summary>
        /// Returns true if CustomAssistantResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomAssistantResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomAssistantResponse input)
        {
            if (input == null)
                return false;
