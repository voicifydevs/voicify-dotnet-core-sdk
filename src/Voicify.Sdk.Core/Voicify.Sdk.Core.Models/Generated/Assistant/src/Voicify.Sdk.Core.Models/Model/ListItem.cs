...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    public partial class ListItem :  IEquatable<ListItem>, IValidatableObject
    {
        ...
        public ListItem(ListItemInfo info = default(ListItemInfo), string title = default(string), string description = default(string), FulfillmentImage image = default(FulfillmentImage))
        {
            this.Info = info;
            this.Title = title;
        ...
        public ListItemInfo Info { get; set; }
