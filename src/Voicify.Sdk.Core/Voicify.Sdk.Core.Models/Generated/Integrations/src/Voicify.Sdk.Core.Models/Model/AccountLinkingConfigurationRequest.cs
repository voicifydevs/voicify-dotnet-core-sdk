...
{
    /// <summary>
    /// AccountLinkingConfigurationRequest
    /// </summary>
    [DataContract]
    public partial class AccountLinkingConfigurationRequest :  IEquatable<AccountLinkingConfigurationRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountLinkingConfigurationRequest" /> class.
        /// </summary>
        ...
        public AccountLinkingConfigurationRequest(string authorizationUri = default(string), string accessTokenUri = default(string), string accountLinkingType = default(string), string clientId = default(string), string clientSecret = default(string), string scopes = default(string), string domains = default(string), string accessTokenScheme = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountLinkingConfigurationRequest {\n");
        ...
        {
            return this.Equals(input as AccountLinkingConfigurationRequest);
        }

        /// <summary>
        /// Returns true if AccountLinkingConfigurationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountLinkingConfigurationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountLinkingConfigurationRequest input)
        {
            if (input == null)
                return false;
