...
{
    /// <summary>
    /// BulkQuestionAnswerUpdateRequest
    /// </summary>
    [DataContract]
    public partial class BulkQuestionAnswerUpdateRequest :  IEquatable<BulkQuestionAnswerUpdateRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkQuestionAnswerUpdateRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BulkQuestionAnswerUpdateRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkQuestionAnswerUpdateRequest" /> class.
        /// </summary>
        ...
        public BulkQuestionAnswerUpdateRequest(List<UpdateQuestionRequest> questions = default(List<UpdateQuestionRequest>), List<UpdateAnswerRequest> answers = default(List<UpdateAnswerRequest>), string title = default(string), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string followUpId = default(string), string repromptId = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), bool? requiresParent = default(bool?), List<string> languageIds = default(List<string>))
        {
            ...
            if (questions == null)
            {
                throw new InvalidDataException("questions is a required property for BulkQuestionAnswerUpdateRequest and cannot be null");
            }
            else
            {
            ...
            if (answers == null)
            {
                throw new InvalidDataException("answers is a required property for BulkQuestionAnswerUpdateRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as BulkQuestionAnswerUpdateRequest);
        }

        /// <summary>
        /// Returns true if BulkQuestionAnswerUpdateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkQuestionAnswerUpdateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkQuestionAnswerUpdateRequest input)
        {
            if (input == null)
                return false;
