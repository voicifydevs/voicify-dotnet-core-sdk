...
{
    /// <summary>
    /// BulkUpdateLatestMessageRequest
    /// </summary>
    [DataContract]
    public partial class BulkUpdateLatestMessageRequest :  IEquatable<BulkUpdateLatestMessageRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkUpdateLatestMessageRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BulkUpdateLatestMessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkUpdateLatestMessageRequest" /> class.
        /// </summary>
        ...
        public BulkUpdateLatestMessageRequest(DateTime? startDate = default(DateTime?), string category = default(string), List<UpdateLatestMessageResponseRequest> responses = default(List<UpdateLatestMessageResponseRequest>), string applicationId = default(string), DateTime? endDate = default(DateTime?), string title = default(string), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string followUpId = default(string), string repromptId = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), bool? requiresParent = default(bool?), List<string> languageIds = default(List<string>))
        {
            ...
            if (startDate == null)
            {
                throw new InvalidDataException("startDate is a required property for BulkUpdateLatestMessageRequest and cannot be null");
            }
            else
            {
            ...
            if (category == null)
            {
                throw new InvalidDataException("category is a required property for BulkUpdateLatestMessageRequest and cannot be null");
            }
            else
            {
            ...
            if (responses == null)
            {
                throw new InvalidDataException("responses is a required property for BulkUpdateLatestMessageRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as BulkUpdateLatestMessageRequest);
        }

        /// <summary>
        /// Returns true if BulkUpdateLatestMessageRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkUpdateLatestMessageRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkUpdateLatestMessageRequest input)
        {
            if (input == null)
                return false;
