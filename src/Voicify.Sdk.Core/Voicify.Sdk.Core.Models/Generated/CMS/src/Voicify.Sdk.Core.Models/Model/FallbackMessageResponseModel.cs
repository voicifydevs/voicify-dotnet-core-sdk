...
{
    /// <summary>
    /// FallbackMessageResponseModel
    /// </summary>
    [DataContract]
        public partial class FallbackMessageResponseModel :  IEquatable<FallbackMessageResponseModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FallbackMessageResponseModel" /> class.
        /// </summary>
        ...
        public FallbackMessageResponseModel(string id = default(string), string content = default(string), string fallbackMessageId = default(string), MediaItemModel smallImage = default(MediaItemModel), MediaItemModel largeImage = default(MediaItemModel), MediaItemModel backgroundImage = default(MediaItemModel), MediaItemModel audio = default(MediaItemModel), MediaItemModel video = default(MediaItemModel), RepromptModel reprompt = default(RepromptModel), string repromptId = default(string), MediaResponseContainerModel mediaResponseContainer = default(MediaResponseContainerModel), FollowUpModel followUp = default(FollowUpModel), DateTime? createdDate = default(DateTime?), DateTime? modifiedDate = default(DateTime?), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), string followUpId = default(string), string responseId = default(string), List<ConditionInstanceModel> conditions = default(List<ConditionInstanceModel>))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FallbackMessageResponseModel {\n");
        ...
        {
            return this.Equals(input as FallbackMessageResponseModel);
        }

        /// <summary>
        /// Returns true if FallbackMessageResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of FallbackMessageResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FallbackMessageResponseModel input)
        {
            if (input == null)
                return false;
