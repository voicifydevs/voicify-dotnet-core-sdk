...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateWelcomeMessageRequest :  IEquatable<UpdateWelcomeMessageRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateWelcomeMessageRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateWelcomeMessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateWelcomeMessageRequest" /> class.
        /// </summary>
        ...
        public UpdateWelcomeMessageRequest(string content = default(string), string title = default(string), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string followUpId = default(string), string repromptId = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), bool? requiresParent = default(bool?), List<string> languageIds = default(List<string>))
        {
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for UpdateWelcomeMessageRequest and cannot be null");
            }
            else
            {
                this.Title = title;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateWelcomeMessageRequest {\n");
        ...
        {
            return this.Equals(input as UpdateWelcomeMessageRequest);
        }

        /// <summary>
        /// Returns true if UpdateWelcomeMessageRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateWelcomeMessageRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateWelcomeMessageRequest input)
        {
            if (input == null)
                return false;
