...
{
    /// <summary>
    /// NewWelcomeMessageStubRequest
    /// </summary>
    [DataContract]
    public partial class NewWelcomeMessageStubRequest :  IEquatable<NewWelcomeMessageStubRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewWelcomeMessageStubRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewWelcomeMessageStubRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewWelcomeMessageStubRequest" /> class.
        /// </summary>
        ...
        public NewWelcomeMessageStubRequest(string title = default(string), string applicationId = default(string), string content = default(string), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string followUpId = default(string), string repromptId = default(string), string applicationFeatureId = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), bool? requiresParent = default(bool?), List<string> languageIds = default(List<string>))
        {
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for NewWelcomeMessageStubRequest and cannot be null");
            }
            else
            {
                this.Title = title;
            ...
            {
                throw new InvalidDataException("applicationFeatureId is a required property for NewWelcomeMessageStubRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as NewWelcomeMessageStubRequest);
        }

        /// <summary>
        /// Returns true if NewWelcomeMessageStubRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NewWelcomeMessageStubRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewWelcomeMessageStubRequest input)
        {
            if (input == null)
                return false;
