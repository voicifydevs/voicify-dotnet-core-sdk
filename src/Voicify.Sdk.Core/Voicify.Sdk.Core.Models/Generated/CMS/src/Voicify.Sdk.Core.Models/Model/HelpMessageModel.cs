...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class HelpMessageModel :  IEquatable<HelpMessageModel>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HelpMessageModel" /> class.
        /// </summary>
        ...
        /// <param name="helpMessageWebhooks">helpMessageWebhooks.</param>
        ...
        public HelpMessageModel(string id = default(string), bool? isLive = default(bool?), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), string applicationId = default(string), string applicationFeatureId = default(string), string title = default(string), string content = default(string), MediaItemModel smallImage = default(MediaItemModel), MediaItemModel largeImage = default(MediaItemModel), MediaItemModel backgroundImage = default(MediaItemModel), MediaItemModel audio = default(MediaItemModel), MediaItemModel video = default(MediaItemModel), List<HelpMessageWebhookModel> helpMessageWebhooks = default(List<HelpMessageWebhookModel>), MediaResponseContainerModel mediaResponseContainer = default(MediaResponseContainerModel), FollowUpModel followUp = default(FollowUpModel), int? hits = default(int?), DateTime? createdDate = default(DateTime?), DateTime? modifiedDate = default(DateTime?), RepromptModel reprompt = default(RepromptModel), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), string followUpId = default(string), bool? requiresParent = default(bool?), string repromptId = default(string), string createdFromId = default(string), bool? isComplete = default(bool?), List<LanguageModel> languages = default(List<LanguageModel>), bool? shouldNotSync = default(bool?), string responseId = default(string), List<HelpMessageResponseModel> responses = default(List<HelpMessageResponseModel>), WebhookChainingType? webhookChainingType = default(WebhookChainingType?), string appliedApplicationTemplateFormId = default(string))
        {
            ...
            this.Audio = audio;
            this.Video = video;
            this.HelpMessageWebhooks = helpMessageWebhooks;
        ...
        /// <summary>
        /// Gets or Sets HelpMessageWebhooks
        /// </summary>
        [DataMember(Name="helpMessageWebhooks", EmitDefaultValue=false)]
        public List<HelpMessageWebhookModel> HelpMessageWebhooks { get; set; }
        ...
        public List<HelpMessageResponseModel> Responses { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HelpMessageModel {\n");
            ...
            sb.Append("  HelpMessageWebhooks: ").Append(HelpMessageWebhooks).Append("\n");
        ...
        {
            return this.Equals(input as HelpMessageModel);
        }

        /// <summary>
        /// Returns true if HelpMessageModel instances are equal
        /// </summary>
        /// <param name="input">Instance of HelpMessageModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HelpMessageModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.HelpMessageWebhooks == input.HelpMessageWebhooks ||
                    this.HelpMessageWebhooks != null &&
                    input.HelpMessageWebhooks != null &&
                    this.HelpMessageWebhooks.SequenceEqual(input.HelpMessageWebhooks)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.HelpMessageWebhooks != null)
                    hashCode = hashCode * 59 + this.HelpMessageWebhooks.GetHashCode();
