...
namespace Voicify.Sdk.Core.Models.Model
{
        ...
        public partial class Body5 :  IEquatable<Body5>
    {
        ...
        public Body5(string contentType = default(string), string contentDisposition = default(string), Dictionary<string, List<string>> headers = default(Dictionary<string, List<string>>), long? length = default(long?), string name = default(string), string fileName = default(string))
        {
