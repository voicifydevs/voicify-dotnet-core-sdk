...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RecipeIngredientModel :  IEquatable<RecipeIngredientModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecipeIngredientModel" /> class.
        /// </summary>
        ...
        public RecipeIngredientModel(string id = default(string), MediaItemModel smallImage = default(MediaItemModel), MediaItemModel largeImage = default(MediaItemModel), MediaItemModel backgroundImage = default(MediaItemModel), MediaItemModel audio = default(MediaItemModel), MediaItemModel video = default(MediaItemModel), MediaResponseContainerModel mediaResponseContainer = default(MediaResponseContainerModel), string content = default(string), string recipeId = default(string), RepromptModel reprompt = default(RepromptModel), DateTime? createdDate = default(DateTime?), DateTime? modifiedDate = default(DateTime?), string mediaResponseContainerId = default(string), string repromptId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), string followUpId = default(string), int? position = default(int?), string responseId = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecipeIngredientModel {\n");
        ...
        {
            return this.Equals(input as RecipeIngredientModel);
        }

        /// <summary>
        /// Returns true if RecipeIngredientModel instances are equal
        /// </summary>
        /// <param name="input">Instance of RecipeIngredientModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecipeIngredientModel input)
        {
            if (input == null)
                return false;
