...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecipeStepModel :  IEquatable<RecipeStepModel>, IValidatableObject
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecipeStepModel {\n");
        ...
        {
            return this.Equals(input as RecipeStepModel);
        }

        /// <summary>
        /// Returns true if RecipeStepModel instances are equal
        /// </summary>
        /// <param name="input">Instance of RecipeStepModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecipeStepModel input)
        {
            if (input == null)
                return false;
