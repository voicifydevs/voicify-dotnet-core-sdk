...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class WebhookFolderModel :  IEquatable<WebhookFolderModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookFolderModel" /> class.
        /// </summary>
        ...
        public WebhookFolderModel(string id = default(string), string parentId = default(string), string name = default(string), string createdFromId = default(string), string applicationId = default(string), int? priority = default(int?), List<WebhookModel> webhooks = default(List<WebhookModel>))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WebhookFolderModel {\n");
        ...
        {
            return this.Equals(input as WebhookFolderModel);
        }

        /// <summary>
        /// Returns true if WebhookFolderModel instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookFolderModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookFolderModel input)
        {
            if (input == null)
                return false;
