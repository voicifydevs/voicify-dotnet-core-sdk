...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    public partial class NewWelcomeMessageRequest :  IEquatable<NewWelcomeMessageRequest>
    {
        ...
        protected NewWelcomeMessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewWelcomeMessageRequest" /> class.
        /// </summary>
        ...
        public NewWelcomeMessageRequest(string content = default(string), string title = default(string), string applicationId = default(string), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string followUpId = default(string), string repromptId = default(string), string applicationFeatureId = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), bool? requiresParent = default(bool?), List<string> languageIds = default(List<string>))
        {
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for NewWelcomeMessageRequest and cannot be null");
            }
            else
            {
                this.Title = title;
            ...
            {
                throw new InvalidDataException("applicationFeatureId is a required property for NewWelcomeMessageRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewWelcomeMessageRequest {\n");
        ...
        {
            return this.Equals(input as NewWelcomeMessageRequest);
        }

        /// <summary>
        /// Returns true if NewWelcomeMessageRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NewWelcomeMessageRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewWelcomeMessageRequest input)
        {
            if (input == null)
                return false;
