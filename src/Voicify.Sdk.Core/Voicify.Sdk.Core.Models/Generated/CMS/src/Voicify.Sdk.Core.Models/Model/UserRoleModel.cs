...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    public partial class UserRoleModel :  IEquatable<UserRoleModel>, IValidatableObject
    {
        ...
        public UserRoleModel(string id = default(string), bool? isAdmin = default(bool?), bool? canEdit = default(bool?), string name = default(string), bool? isCustom = default(bool?))
        {
            this.Id = id;
