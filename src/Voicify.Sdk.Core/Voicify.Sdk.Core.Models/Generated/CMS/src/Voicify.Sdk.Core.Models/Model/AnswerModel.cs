...
namespace Voicify.Sdk.Core.Models.Model
{
        ...
        public partial class AnswerModel :  IEquatable<AnswerModel>
    {
        ...
        public AnswerModel(string id = default(string), string content = default(string), MediaItemModel smallImage = default(MediaItemModel), MediaItemModel largeImage = default(MediaItemModel), MediaItemModel backgroundImage = default(MediaItemModel), MediaItemModel audio = default(MediaItemModel), MediaItemModel video = default(MediaItemModel), MediaResponseContainerModel mediaResponseContainer = default(MediaResponseContainerModel), RepromptModel reprompt = default(RepromptModel), FollowUpModel followUp = default(FollowUpModel), string repromptId = default(string), DateTime? createdDate = default(DateTime?), DateTime? modifiedDate = default(DateTime?), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), string followUpId = default(string), string questionAnswerId = default(string), string responseId = default(string), List<ConditionInstanceModel> conditions = default(List<ConditionInstanceModel>), List<ResponseFlagRuleModel> flagRules = default(List<ResponseFlagRuleModel>))
        {
            this.Id = id;
