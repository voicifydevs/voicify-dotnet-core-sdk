...
{
    /// <summary>
    /// NewExitMessageRequest
    /// </summary>
    [DataContract]
    public partial class NewExitMessageRequest :  IEquatable<NewExitMessageRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewExitMessageRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewExitMessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewExitMessageRequest" /> class.
        /// </summary>
        ...
        public NewExitMessageRequest(string content = default(string), string title = default(string), string applicationId = default(string), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string applicationFeatureId = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), bool? requiresParent = default(bool?), List<string> languageIds = default(List<string>))
        {
            // to ensure "content" is required (not null)
            if (content == null)
            {
                throw new InvalidDataException("content is a required property for NewExitMessageRequest and cannot be null");
            }
            else
            {
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for NewExitMessageRequest and cannot be null");
            }
            else
            {
                this.Title = title;
            ...
            {
                throw new InvalidDataException("applicationId is a required property for NewExitMessageRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("applicationFeatureId is a required property for NewExitMessageRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewExitMessageRequest {\n");
        ...
        {
            return this.Equals(input as NewExitMessageRequest);
        }

        /// <summary>
        /// Returns true if NewExitMessageRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NewExitMessageRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewExitMessageRequest input)
        {
            if (input == null)
                return false;
