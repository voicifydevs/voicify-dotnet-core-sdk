...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    public partial class NewExitMessageStubRequest :  IEquatable<NewExitMessageStubRequest>, IValidatableObject
    {
        ...
        protected NewExitMessageStubRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewExitMessageStubRequest" /> class.
        /// </summary>
        ...
        public NewExitMessageStubRequest(string content = default(string), string title = default(string), string applicationId = default(string), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string applicationFeatureId = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), bool? requiresParent = default(bool?), List<string> languageIds = default(List<string>))
        {
            ...
            {
                throw new InvalidDataException("applicationId is a required property for NewExitMessageStubRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("applicationFeatureId is a required property for NewExitMessageStubRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewExitMessageStubRequest {\n");
        ...
        {
            return this.Equals(input as NewExitMessageStubRequest);
        }

        /// <summary>
        /// Returns true if NewExitMessageStubRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NewExitMessageStubRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewExitMessageStubRequest input)
        {
            if (input == null)
                return false;
