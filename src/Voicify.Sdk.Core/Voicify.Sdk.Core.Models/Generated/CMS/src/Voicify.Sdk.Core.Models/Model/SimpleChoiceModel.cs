...
namespace Voicify.Sdk.Core.Models.Model
{
        ...
        public partial class SimpleChoiceModel :  IEquatable<SimpleChoiceModel>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SimpleChoiceModel {\n");
        ...
        {
            return this.Equals(input as SimpleChoiceModel);
        }

        /// <summary>
        /// Returns true if SimpleChoiceModel instances are equal
        /// </summary>
        /// <param name="input">Instance of SimpleChoiceModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimpleChoiceModel input)
        {
            if (input == null)
                return false;
