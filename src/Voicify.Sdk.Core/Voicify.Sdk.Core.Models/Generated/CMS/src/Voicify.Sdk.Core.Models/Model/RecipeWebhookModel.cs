...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecipeWebhookModel :  IEquatable<RecipeWebhookModel>, IValidatableObject
    {
        /// <summary>
        ...
        public RecipeWebhookModel(string id = default(string), string recipeId = default(string), WebhookModel webhook = default(WebhookModel), List<WebhookParameterValueModel> parameterValues = default(List<WebhookParameterValueModel>))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecipeWebhookModel {\n");
        ...
        {
            return this.Equals(input as RecipeWebhookModel);
        }

        /// <summary>
        /// Returns true if RecipeWebhookModel instances are equal
        /// </summary>
        /// <param name="input">Instance of RecipeWebhookModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecipeWebhookModel input)
        {
            if (input == null)
                return false;
