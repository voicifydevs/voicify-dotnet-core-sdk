...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateIngredientRequest :  IEquatable<CreateIngredientRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateIngredientRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateIngredientRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateIngredientRequest" /> class.
        /// </summary>
        ...
        public CreateIngredientRequest(string content = default(string), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string))
        {
            // to ensure "content" is required (not null)
            if (content == null)
            {
                throw new InvalidDataException("content is a required property for CreateIngredientRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateIngredientRequest {\n");
        ...
        {
            return this.Equals(input as CreateIngredientRequest);
        }

        /// <summary>
        /// Returns true if CreateIngredientRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateIngredientRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateIngredientRequest input)
        {
            if (input == null)
                return false;
