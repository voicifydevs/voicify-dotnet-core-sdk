...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    public partial class NewNumberRangeRequest :  IEquatable<NewNumberRangeRequest>, IValidatableObject
    {
        ...
        protected NewNumberRangeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewNumberRangeRequest" /> class.
        /// </summary>
        ...
        public NewNumberRangeRequest(List<NewNumberRangeResponseRequest> responses = default(List<NewNumberRangeResponseRequest>), string applicationId = default(string), string applicationFeatureId = default(string), double? minimumValue = default(double?), double? maximumValue = default(double?), string title = default(string), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string followUpId = default(string), string repromptId = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), List<string> languageIds = default(List<string>))
        {
            ...
            {
                throw new InvalidDataException("applicationId is a required property for NewNumberRangeRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("applicationFeatureId is a required property for NewNumberRangeRequest and cannot be null");
            }
            else
            {
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for NewNumberRangeRequest and cannot be null");
            }
            else
            {
                this.Title = title;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewNumberRangeRequest {\n");
        ...
        {
            return this.Equals(input as NewNumberRangeRequest);
        }

        /// <summary>
        /// Returns true if NewNumberRangeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NewNumberRangeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewNumberRangeRequest input)
        {
            if (input == null)
                return false;
