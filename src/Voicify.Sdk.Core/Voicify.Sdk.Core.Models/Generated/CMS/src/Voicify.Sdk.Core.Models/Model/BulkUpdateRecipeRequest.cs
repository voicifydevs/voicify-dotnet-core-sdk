...
{
    /// <summary>
    /// BulkUpdateRecipeRequest
    /// </summary>
    [DataContract]
    public partial class BulkUpdateRecipeRequest :  IEquatable<BulkUpdateRecipeRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkUpdateRecipeRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BulkUpdateRecipeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkUpdateRecipeRequest" /> class.
        /// </summary>
        ...
        public BulkUpdateRecipeRequest(string recipeName = default(string), List<UpdateStepRequest> steps = default(List<UpdateStepRequest>), List<UpdateIngredientRequest> ingredients = default(List<UpdateIngredientRequest>), string title = default(string), string keywords = default(string), string description = default(string), string mealType = default(string), string servings = default(string), string totalTime = default(string), int? calories = default(int?), string videoItemId = default(string), string smallImageItemId = default(string), string largeImageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string content = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), bool? requiresParent = default(bool?), List<string> languageIds = default(List<string>))
        {
            // to ensure "recipeName" is required (not null)
            if (recipeName == null)
            {
                throw new InvalidDataException("recipeName is a required property for BulkUpdateRecipeRequest and cannot be null");
            }
            else
            {
            ...
            if (steps == null)
            {
                throw new InvalidDataException("steps is a required property for BulkUpdateRecipeRequest and cannot be null");
            }
            else
            {
                this.Steps = steps;
            ...
            if (ingredients == null)
            {
                throw new InvalidDataException("ingredients is a required property for BulkUpdateRecipeRequest and cannot be null");
            }
            else
            {
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for BulkUpdateRecipeRequest and cannot be null");
            }
            else
            {
                this.Title = title;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BulkUpdateRecipeRequest {\n");
        ...
        {
            return this.Equals(input as BulkUpdateRecipeRequest);
        }

        /// <summary>
        /// Returns true if BulkUpdateRecipeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkUpdateRecipeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkUpdateRecipeRequest input)
        {
            if (input == null)
                return false;
