...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FallbackMessageWebhookModel :  IEquatable<FallbackMessageWebhookModel>, IValidatableObject
    {
        /// <summary>
        ...
        public FallbackMessageWebhookModel(string id = default(string), string fallbackMessageId = default(string), WebhookModel webhook = default(WebhookModel), List<WebhookParameterValueModel> parameterValues = default(List<WebhookParameterValueModel>))
        {
            this.Id = id;
