...
{
    /// <summary>
    /// FallbackMessageWebhookModel
    /// </summary>
    [DataContract]
        public partial class FallbackMessageWebhookModel :  IEquatable<FallbackMessageWebhookModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FallbackMessageWebhookModel" /> class.
        /// </summary>
        ...
        public FallbackMessageWebhookModel(string id = default(string), string fallbackMessageId = default(string), WebhookModel webhook = default(WebhookModel), List<WebhookParameterValueModel> parameterValues = default(List<WebhookParameterValueModel>), int? priority = default(int?))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FallbackMessageWebhookModel {\n");
        ...
        {
            return this.Equals(input as FallbackMessageWebhookModel);
        }

        /// <summary>
        /// Returns true if FallbackMessageWebhookModel instances are equal
        /// </summary>
        /// <param name="input">Instance of FallbackMessageWebhookModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FallbackMessageWebhookModel input)
        {
            if (input == null)
                return false;
