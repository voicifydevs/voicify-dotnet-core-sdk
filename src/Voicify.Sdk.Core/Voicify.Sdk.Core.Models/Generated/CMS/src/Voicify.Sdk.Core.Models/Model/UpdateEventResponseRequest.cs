...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    public partial class UpdateEventResponseRequest :  IEquatable<UpdateEventResponseRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEventResponseRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateEventResponseRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEventResponseRequest" /> class.
        /// </summary>
        ...
        public UpdateEventResponseRequest(string id = default(string), string content = default(string), EventQueryTypeEnum? eventQueryType = default(EventQueryTypeEnum?), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string))
        {
            // to ensure "content" is required (not null)
            if (content == null)
            {
                throw new InvalidDataException("content is a required property for UpdateEventResponseRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateEventResponseRequest {\n");
        ...
        {
            return this.Equals(input as UpdateEventResponseRequest);
        }

        /// <summary>
        /// Returns true if UpdateEventResponseRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateEventResponseRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateEventResponseRequest input)
        {
            if (input == null)
                return false;
