...
namespace Voicify.Sdk.Core.Models.Model
{
        ...
        public partial class OrganizationMemberModel :  IEquatable<OrganizationMemberModel>
    {
        ...
        public OrganizationMemberModel(string id = default(string), string organizationId = default(string), string userId = default(string), string email = default(string), string firstName = default(string), string lastName = default(string), bool? isAdmin = default(bool?), bool? canEdit = default(bool?), string imageUrl = default(string), DateTime? createdDate = default(DateTime?), bool? isApiUser = default(bool?))
        {
            this.Id = id;
