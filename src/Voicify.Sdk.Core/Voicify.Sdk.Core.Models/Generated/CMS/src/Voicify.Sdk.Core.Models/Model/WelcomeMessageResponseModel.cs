...
{
    /// <summary>
    /// WelcomeMessageResponseModel
    /// </summary>
    [DataContract]
        public partial class WelcomeMessageResponseModel :  IEquatable<WelcomeMessageResponseModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WelcomeMessageResponseModel" /> class.
        /// </summary>
        ...
        public WelcomeMessageResponseModel(string id = default(string), string content = default(string), string welcomeMessageId = default(string), MediaItemModel smallImage = default(MediaItemModel), MediaItemModel largeImage = default(MediaItemModel), MediaItemModel backgroundImage = default(MediaItemModel), MediaItemModel audio = default(MediaItemModel), MediaItemModel video = default(MediaItemModel), RepromptModel reprompt = default(RepromptModel), string repromptId = default(string), MediaResponseContainerModel mediaResponseContainer = default(MediaResponseContainerModel), FollowUpModel followUp = default(FollowUpModel), DateTime? createdDate = default(DateTime?), DateTime? modifiedDate = default(DateTime?), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), string followUpId = default(string), string responseId = default(string), List<ConditionInstanceModel> conditions = default(List<ConditionInstanceModel>))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WelcomeMessageResponseModel {\n");
        ...
        {
            return this.Equals(input as WelcomeMessageResponseModel);
        }

        /// <summary>
        /// Returns true if WelcomeMessageResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of WelcomeMessageResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WelcomeMessageResponseModel input)
        {
            if (input == null)
                return false;
