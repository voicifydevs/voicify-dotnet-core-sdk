...
namespace Voicify.Sdk.Core.Models.Model
{
        ...
        public partial class WelcomeMessageWebhookModel :  IEquatable<WelcomeMessageWebhookModel>
    {
        ...
        public WelcomeMessageWebhookModel(string id = default(string), string welcomeMessageId = default(string), WebhookModel webhook = default(WebhookModel), List<WebhookParameterValueModel> parameterValues = default(List<WebhookParameterValueModel>), int? priority = default(int?))
        {
            this.Id = id;
