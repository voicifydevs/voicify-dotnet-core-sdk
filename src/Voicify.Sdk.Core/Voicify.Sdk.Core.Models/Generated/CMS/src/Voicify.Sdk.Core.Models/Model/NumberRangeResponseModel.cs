...
{
    /// <summary>
    /// NumberRangeResponseModel
    /// </summary>
    [DataContract]
    public partial class NumberRangeResponseModel :  IEquatable<NumberRangeResponseModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NumberRangeResponseModel" /> class.
        /// </summary>
        ...
        public NumberRangeResponseModel(string id = default(string), string content = default(string), string numberRangeId = default(string), MediaItemModel smallImage = default(MediaItemModel), MediaItemModel largeImage = default(MediaItemModel), MediaItemModel backgroundImage = default(MediaItemModel), MediaItemModel audio = default(MediaItemModel), MediaItemModel video = default(MediaItemModel), RepromptModel reprompt = default(RepromptModel), string repromptId = default(string), MediaResponseContainerModel mediaResponseContainer = default(MediaResponseContainerModel), FollowUpModel followUp = default(FollowUpModel), DateTime? createdDate = default(DateTime?), DateTime? modifiedDate = default(DateTime?), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), string followUpId = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NumberRangeResponseModel {\n");
        ...
        {
            return this.Equals(input as NumberRangeResponseModel);
        }

        /// <summary>
        /// Returns true if NumberRangeResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of NumberRangeResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NumberRangeResponseModel input)
        {
            if (input == null)
                return false;
