...
namespace Voicify.Sdk.Core.Models.Model
{
        ...
        public partial class BulkUpdateSimpleChoiceRequest :  IEquatable<BulkUpdateSimpleChoiceRequest>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkUpdateSimpleChoiceRequest" /> class.
        /// </summary>
        ...
        public BulkUpdateSimpleChoiceRequest(string applicationId = default(string), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string followUpId = default(string), string repromptId = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), List<string> languageIds = default(List<string>), SimpleChoiceType choiceType = default(SimpleChoiceType), string title = default(string), List<UpdateSimpleChoiceResponseRequest> responses = default(List<UpdateSimpleChoiceResponseRequest>))
        {
            ...
            if (choiceType == null)
            {
                throw new InvalidDataException("choiceType is a required property for BulkUpdateSimpleChoiceRequest and cannot be null");
            }
            else
            {
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for BulkUpdateSimpleChoiceRequest and cannot be null");
            }
            else
            {
                this.Title = title;
            ...
            if (responses == null)
            {
                throw new InvalidDataException("responses is a required property for BulkUpdateSimpleChoiceRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BulkUpdateSimpleChoiceRequest {\n");
        ...
        {
            return this.Equals(input as BulkUpdateSimpleChoiceRequest);
        }

        /// <summary>
        /// Returns true if BulkUpdateSimpleChoiceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkUpdateSimpleChoiceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkUpdateSimpleChoiceRequest input)
        {
            if (input == null)
                return false;
