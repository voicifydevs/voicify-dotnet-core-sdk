...
{
    /// <summary>
    /// AzureBotServiceInformation
    /// </summary>
    [DataContract]
    public partial class AzureBotServiceInformation :  IEquatable<AzureBotServiceInformation>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as AzureBotServiceInformation);
        }

        /// <summary>
        /// Returns true if AzureBotServiceInformation instances are equal
        /// </summary>
        /// <param name="input">Instance of AzureBotServiceInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AzureBotServiceInformation input)
        {
            if (input == null)
                return false;
