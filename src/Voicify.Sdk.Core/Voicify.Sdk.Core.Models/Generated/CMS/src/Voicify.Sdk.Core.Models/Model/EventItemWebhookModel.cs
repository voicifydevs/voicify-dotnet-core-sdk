...
{
    /// <summary>
    /// EventItemWebhookModel
    /// </summary>
    [DataContract]
    public partial class EventItemWebhookModel :  IEquatable<EventItemWebhookModel>, IValidatableObject
    {
        /// <summary>
        ...
        public EventItemWebhookModel(string id = default(string), string eventItemId = default(string), WebhookModel webhook = default(WebhookModel), List<WebhookParameterValueModel> parameterValues = default(List<WebhookParameterValueModel>))
        {
            this.Id = id;
        ...
        /// <summary>
        /// Gets or Sets EventItemId
        /// </summary>
        [DataMember(Name="eventItemId", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EventItemWebhookModel {\n");
            sb.Append("  Id: ").Append(Id).Append("\n");
            sb.Append("  EventItemId: ").Append(EventItemId).Append("\n");
        ...
        {
            return this.Equals(input as EventItemWebhookModel);
        }

        /// <summary>
        /// Returns true if EventItemWebhookModel instances are equal
        /// </summary>
        /// <param name="input">Instance of EventItemWebhookModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EventItemWebhookModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.EventItemId == input.EventItemId ||
                    (this.EventItemId != null &&
                    this.EventItemId.Equals(input.EventItemId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.EventItemId != null)
                    hashCode = hashCode * 59 + this.EventItemId.GetHashCode();
