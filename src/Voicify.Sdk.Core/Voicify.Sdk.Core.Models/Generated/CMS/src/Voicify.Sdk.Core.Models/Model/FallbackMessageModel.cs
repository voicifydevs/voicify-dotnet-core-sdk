...
{
    /// <summary>
    /// FallbackMessageModel
    /// </summary>
    [DataContract]
        public partial class FallbackMessageModel :  IEquatable<FallbackMessageModel>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FallbackMessageModel {\n");
        ...
        {
            return this.Equals(input as FallbackMessageModel);
        }

        /// <summary>
        /// Returns true if FallbackMessageModel instances are equal
        /// </summary>
        /// <param name="input">Instance of FallbackMessageModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FallbackMessageModel input)
        {
            if (input == null)
                return false;
