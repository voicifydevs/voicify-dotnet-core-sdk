...
namespace Voicify.Sdk.Core.Models.Model
{
        ...
        public partial class ResponseModel :  IEquatable<ResponseModel>
    {
        ...
        public ResponseModel(string id = default(string), string content = default(string), MediaItemModel smallImage = default(MediaItemModel), MediaItemModel largeImage = default(MediaItemModel), MediaItemModel backgroundImage = default(MediaItemModel), MediaItemModel audio = default(MediaItemModel), MediaItemModel video = default(MediaItemModel), string repromptId = default(string), RepromptModel reprompt = default(RepromptModel), MediaResponseContainerModel mediaResponseContainer = default(MediaResponseContainerModel), FollowUpModel followUp = default(FollowUpModel), DateTime? createdDate = default(DateTime?), DateTime? modifiedDate = default(DateTime?), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), string followUpId = default(string), string name = default(string), string responseId = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ResponseModel);
        }

        /// <summary>
        /// Returns true if ResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseModel input)
        {
            if (input == null)
                return false;
