...
{
    /// <summary>
    /// ExitMessageResponseModel
    /// </summary>
    [DataContract]
        public partial class ExitMessageResponseModel :  IEquatable<ExitMessageResponseModel>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExitMessageResponseModel {\n");
        ...
        {
            return this.Equals(input as ExitMessageResponseModel);
        }

        /// <summary>
        /// Returns true if ExitMessageResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ExitMessageResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExitMessageResponseModel input)
        {
            if (input == null)
                return false;
