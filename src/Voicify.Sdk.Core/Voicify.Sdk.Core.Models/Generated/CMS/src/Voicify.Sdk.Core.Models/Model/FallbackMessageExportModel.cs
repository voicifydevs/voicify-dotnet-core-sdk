...
{
    /// <summary>
    /// FallbackMessageExportModel
    /// </summary>
    [DataContract]
        public partial class FallbackMessageExportModel :  IEquatable<FallbackMessageExportModel>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FallbackMessageExportModel" /> class.
        /// </summary>
        ...
        public FallbackMessageCategoryModel Category { get; set; }
        ...
        /// <summary>
        /// Gets or Sets FallbackMessageWebhooks
        /// </summary>
        [DataMember(Name="fallbackMessageWebhooks", EmitDefaultValue=false)]
        public List<FallbackMessageWebhookModel> FallbackMessageWebhooks { get; set; }
        ...
        public List<FallbackMessageResponseModel> Responses { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FallbackMessageExportModel {\n");
            ...
            sb.Append("  FallbackMessageWebhooks: ").Append(FallbackMessageWebhooks).Append("\n");
        ...
        {
            return this.Equals(input as FallbackMessageExportModel);
        }

        /// <summary>
        /// Returns true if FallbackMessageExportModel instances are equal
        /// </summary>
        /// <param name="input">Instance of FallbackMessageExportModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FallbackMessageExportModel input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.FallbackMessageWebhooks == input.FallbackMessageWebhooks ||
                    this.FallbackMessageWebhooks != null &&
                    input.FallbackMessageWebhooks != null &&
                    this.FallbackMessageWebhooks.SequenceEqual(input.FallbackMessageWebhooks)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FallbackMessageWebhooks != null)
                    hashCode = hashCode * 59 + this.FallbackMessageWebhooks.GetHashCode();
