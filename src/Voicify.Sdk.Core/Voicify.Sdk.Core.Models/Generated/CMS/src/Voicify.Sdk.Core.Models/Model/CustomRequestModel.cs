...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CustomRequestModel :  IEquatable<CustomRequestModel>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomRequestModel" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomRequestModel {\n");
        ...
        {
            return this.Equals(input as CustomRequestModel);
        }

        /// <summary>
        /// Returns true if CustomRequestModel instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomRequestModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomRequestModel input)
        {
            if (input == null)
                return false;
