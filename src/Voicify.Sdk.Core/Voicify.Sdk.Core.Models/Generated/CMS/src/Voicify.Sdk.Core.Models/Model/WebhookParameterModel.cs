...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    public partial class WebhookParameterModel :  IEquatable<WebhookParameterModel>, IValidatableObject
    {
        ...
        public WebhookParameterModel(string id = default(string), string name = default(string), string description = default(string), string webhookId = default(string), string createdFromId = default(string))
        {
            this.Id = id;
            this.Name = name;
