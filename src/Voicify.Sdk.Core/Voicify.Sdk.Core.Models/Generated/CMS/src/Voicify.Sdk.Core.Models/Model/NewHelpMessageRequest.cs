...
{
    /// <summary>
    /// NewHelpMessageRequest
    /// </summary>
    [DataContract]
    public partial class NewHelpMessageRequest :  IEquatable<NewHelpMessageRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewHelpMessageRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewHelpMessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewHelpMessageRequest" /> class.
        /// </summary>
        ...
        public NewHelpMessageRequest(string content = default(string), string title = default(string), string applicationId = default(string), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string applicationFeatureId = default(string), string followUpId = default(string), string repromptId = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), bool? requiresParent = default(bool?), List<string> languageIds = default(List<string>))
        {
            // to ensure "content" is required (not null)
            if (content == null)
            {
                throw new InvalidDataException("content is a required property for NewHelpMessageRequest and cannot be null");
            }
            else
            {
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for NewHelpMessageRequest and cannot be null");
            }
            else
            {
                this.Title = title;
            ...
            {
                throw new InvalidDataException("applicationFeatureId is a required property for NewHelpMessageRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewHelpMessageRequest {\n");
        ...
        {
            return this.Equals(input as NewHelpMessageRequest);
        }

        /// <summary>
        /// Returns true if NewHelpMessageRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NewHelpMessageRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewHelpMessageRequest input)
        {
            if (input == null)
                return false;
