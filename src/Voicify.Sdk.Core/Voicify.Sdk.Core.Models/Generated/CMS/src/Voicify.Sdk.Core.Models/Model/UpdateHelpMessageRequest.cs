...
{
    /// <summary>
    /// UpdateHelpMessageRequest
    /// </summary>
    [DataContract]
        public partial class UpdateHelpMessageRequest :  IEquatable<UpdateHelpMessageRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateHelpMessageRequest" /> class.
        /// </summary>
        ...
        public UpdateHelpMessageRequest(string title = default(string), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string followUpId = default(string), string repromptId = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), bool? requiresParent = default(bool?), List<string> languageIds = default(List<string>), string content = default(string))
        {
            ...
            if (content == null)
            {
                throw new InvalidDataException("content is a required property for UpdateHelpMessageRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateHelpMessageRequest {\n");
        ...
        {
            return this.Equals(input as UpdateHelpMessageRequest);
        }

        /// <summary>
        /// Returns true if UpdateHelpMessageRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateHelpMessageRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateHelpMessageRequest input)
        {
            if (input == null)
                return false;
