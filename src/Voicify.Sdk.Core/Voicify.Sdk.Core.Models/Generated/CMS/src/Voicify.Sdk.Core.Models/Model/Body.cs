...
namespace Voicify.Sdk.Core.Models.Model
{
        ...
        public partial class Body :  IEquatable<Body>
    {
        ...
        public Body(string contentType = default(string), string contentDisposition = default(string), Dictionary<string, List<string>> headers = default(Dictionary<string, List<string>>), long? length = default(long?), string name = default(string), string fileName = default(string))
        {
