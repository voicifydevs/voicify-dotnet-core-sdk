...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class NewWebhookRequest :  IEquatable<NewWebhookRequest>
    {
        /// <summary>
        ...
        public NewWebhookRequest(string title = default(string), string description = default(string), string webhookTypeId = default(string), string url = default(string), string accessToken = default(string), string webhookFolderId = default(string))
        {
