...
{
    /// <summary>
    /// NewLatestMessageStubRequest
    /// </summary>
    [DataContract]
    public partial class NewLatestMessageStubRequest :  IEquatable<NewLatestMessageStubRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewLatestMessageStubRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewLatestMessageStubRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewLatestMessageStubRequest" /> class.
        /// </summary>
        ...
        public NewLatestMessageStubRequest(string applicationId = default(string), string applicationFeatureId = default(string), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), string category = default(string), string title = default(string), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string followUpId = default(string), string repromptId = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), List<NewLatestMessageResponseRequest> responses = default(List<NewLatestMessageResponseRequest>), bool? requiresParent = default(bool?), List<string> languageIds = default(List<string>))
        {
            // to ensure "applicationId" is required (not null)
            if (applicationId == null)
            {
                throw new InvalidDataException("applicationId is a required property for NewLatestMessageStubRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("applicationFeatureId is a required property for NewLatestMessageStubRequest and cannot be null");
            }
            else
            {
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for NewLatestMessageStubRequest and cannot be null");
            }
            else
            {
                this.Title = title;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewLatestMessageStubRequest {\n");
        ...
        {
            return this.Equals(input as NewLatestMessageStubRequest);
        }

        /// <summary>
        /// Returns true if NewLatestMessageStubRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NewLatestMessageStubRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewLatestMessageStubRequest input)
        {
            if (input == null)
                return false;
