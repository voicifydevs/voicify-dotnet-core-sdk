...
{
    /// <summary>
    /// NewFallbackMessageStubRequest
    /// </summary>
    [DataContract]
    public partial class NewFallbackMessageStubRequest :  IEquatable<NewFallbackMessageStubRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewFallbackMessageStubRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewFallbackMessageStubRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewFallbackMessageStubRequest" /> class.
        /// </summary>
        ...
        public NewFallbackMessageStubRequest(string content = default(string), string title = default(string), string applicationId = default(string), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string applicationFeatureId = default(string), string categoryId = default(string), string followUpId = default(string), string repromptId = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), bool? requiresParent = default(bool?), List<string> languageIds = default(List<string>))
        {
            ...
            {
                throw new InvalidDataException("applicationFeatureId is a required property for NewFallbackMessageStubRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewFallbackMessageStubRequest {\n");
        ...
        {
            return this.Equals(input as NewFallbackMessageStubRequest);
        }

        /// <summary>
        /// Returns true if NewFallbackMessageStubRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NewFallbackMessageStubRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewFallbackMessageStubRequest input)
        {
            if (input == null)
                return false;
