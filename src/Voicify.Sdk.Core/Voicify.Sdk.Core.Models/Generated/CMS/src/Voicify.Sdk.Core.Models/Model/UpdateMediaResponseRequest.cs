...
{
    /// <summary>
    /// UpdateMediaResponseRequest
    /// </summary>
    [DataContract]
    public partial class UpdateMediaResponseRequest :  IEquatable<UpdateMediaResponseRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateMediaResponseRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateMediaResponseRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateMediaResponseRequest" /> class.
        /// </summary>
        ...
        public UpdateMediaResponseRequest(string id = default(string), string responseTemplateTypeId = default(string), string applicationId = default(string), string displayTitle = default(string), string displayText = default(string), string readoutOverride = default(string), string foregroundImageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string deviceTargetId = default(string), string customMarkup = default(string))
        {
            ...
            {
                throw new InvalidDataException("responseTemplateTypeId is a required property for UpdateMediaResponseRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("applicationId is a required property for UpdateMediaResponseRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as UpdateMediaResponseRequest);
        }

        /// <summary>
        /// Returns true if UpdateMediaResponseRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateMediaResponseRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateMediaResponseRequest input)
        {
            if (input == null)
                return false;
