...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    public partial class UpdateWebhookRequest :  IEquatable<UpdateWebhookRequest>
    {
        ...
        public UpdateWebhookRequest(string title = default(string), string description = default(string), string url = default(string), bool? isPublic = default(bool?), bool? isDisabled = default(bool?), string webhookTypeId = default(string), string accessToken = default(string))
        {
