...
{
    /// <summary>
    /// BulkQuestionAnswerUpdateStubRequest
    /// </summary>
    [DataContract]
    public partial class BulkQuestionAnswerUpdateStubRequest :  IEquatable<BulkQuestionAnswerUpdateStubRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkQuestionAnswerUpdateStubRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BulkQuestionAnswerUpdateStubRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkQuestionAnswerUpdateStubRequest" /> class.
        /// </summary>
        ...
        public BulkQuestionAnswerUpdateStubRequest(string title = default(string), List<UpdateQuestionRequest> questions = default(List<UpdateQuestionRequest>), List<UpdateAnswerRequest> answers = default(List<UpdateAnswerRequest>), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string followUpId = default(string), string repromptId = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), bool? requiresParent = default(bool?), List<string> languageIds = default(List<string>))
        {
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for BulkQuestionAnswerUpdateStubRequest and cannot be null");
            }
            else
            {
                this.Title = title;
        ...
        {
            return this.Equals(input as BulkQuestionAnswerUpdateStubRequest);
        }

        /// <summary>
        /// Returns true if BulkQuestionAnswerUpdateStubRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkQuestionAnswerUpdateStubRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkQuestionAnswerUpdateStubRequest input)
        {
            if (input == null)
                return false;
