...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    public partial class NewSimpleChoiceStubRequest :  IEquatable<NewSimpleChoiceStubRequest>, IValidatableObject
    {
        ...
        protected NewSimpleChoiceStubRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewSimpleChoiceStubRequest" /> class.
        /// </summary>
        ...
        public NewSimpleChoiceStubRequest(string applicationId = default(string), List<NewSimpleChoiceResponseRequest> responses = default(List<NewSimpleChoiceResponseRequest>), string applicationFeatureId = default(string), ChoiceTypeEnum? choiceType = default(ChoiceTypeEnum?), string title = default(string), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string followUpId = default(string), string repromptId = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), List<string> languageIds = default(List<string>))
        {
            // to ensure "applicationId" is required (not null)
            if (applicationId == null)
            {
                throw new InvalidDataException("applicationId is a required property for NewSimpleChoiceStubRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("applicationFeatureId is a required property for NewSimpleChoiceStubRequest and cannot be null");
            }
            else
            {
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for NewSimpleChoiceStubRequest and cannot be null");
            }
            else
            {
                this.Title = title;
        ...
        {
            return this.Equals(input as NewSimpleChoiceStubRequest);
        }

        /// <summary>
        /// Returns true if NewSimpleChoiceStubRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NewSimpleChoiceStubRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewSimpleChoiceStubRequest input)
        {
            if (input == null)
                return false;
