...
namespace Voicify.Sdk.Core.Models.Model
{
        ...
        public partial class QueuedInteractionModelUpdate :  IEquatable<QueuedInteractionModelUpdate>
    {
        ...
        public QueuedInteractionModelUpdate(DateTime? createdDate = default(DateTime?), string platform = default(string), string applicationId = default(string), string locale = default(string), string id = default(string), int? retryCount = default(int?), string actions = default(string), string packageId = default(string))
        {
