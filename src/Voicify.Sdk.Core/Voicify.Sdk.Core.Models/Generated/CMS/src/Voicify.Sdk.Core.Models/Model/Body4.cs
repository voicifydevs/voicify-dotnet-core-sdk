...
namespace Voicify.Sdk.Core.Models.Model
{
        ...
        public partial class Body4 :  IEquatable<Body4>
    {
        ...
        public Body4(string samlResponse = default(string))
        {
            this.SamlResponse = samlResponse;
        }
        
        /// <summary>
        /// Gets or Sets SamlResponse
        /// </summary>
        ...
        public bool Equals(Body4 input)
        {
            ...
            return 
                (
                    this.SamlResponse == input.SamlResponse ||
                    (this.SamlResponse != null &&
                    this.SamlResponse.Equals(input.SamlResponse))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SamlResponse != null)
                    hashCode = hashCode * 59 + this.SamlResponse.GetHashCode();
                return hashCode;
            }
        }
