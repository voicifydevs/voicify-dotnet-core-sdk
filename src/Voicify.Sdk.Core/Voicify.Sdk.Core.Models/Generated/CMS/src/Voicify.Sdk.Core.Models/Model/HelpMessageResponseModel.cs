...
{
    /// <summary>
    /// HelpMessageResponseModel
    /// </summary>
    [DataContract]
        public partial class HelpMessageResponseModel :  IEquatable<HelpMessageResponseModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HelpMessageResponseModel" /> class.
        /// </summary>
        ...
        public HelpMessageResponseModel(string id = default(string), string content = default(string), string helpMessageId = default(string), MediaItemModel smallImage = default(MediaItemModel), MediaItemModel largeImage = default(MediaItemModel), MediaItemModel backgroundImage = default(MediaItemModel), MediaItemModel audio = default(MediaItemModel), MediaItemModel video = default(MediaItemModel), RepromptModel reprompt = default(RepromptModel), string repromptId = default(string), MediaResponseContainerModel mediaResponseContainer = default(MediaResponseContainerModel), FollowUpModel followUp = default(FollowUpModel), DateTime? createdDate = default(DateTime?), DateTime? modifiedDate = default(DateTime?), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), string followUpId = default(string), string responseId = default(string), List<ConditionInstanceModel> conditions = default(List<ConditionInstanceModel>))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HelpMessageResponseModel {\n");
        ...
        {
            return this.Equals(input as HelpMessageResponseModel);
        }

        /// <summary>
        /// Returns true if HelpMessageResponseModel instances are equal
        /// </summary>
        /// <param name="input">Instance of HelpMessageResponseModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HelpMessageResponseModel input)
        {
            if (input == null)
                return false;
