...
{
    /// <summary>
    /// ApplicationFeatureWebhookModel
    /// </summary>
    [DataContract]
    public partial class ApplicationFeatureWebhookModel :  IEquatable<ApplicationFeatureWebhookModel>, IValidatableObject
    {
        /// <summary>
        ...
        public ApplicationFeatureWebhookModel(string id = default(string), string applicationFeatureId = default(string), WebhookModel webhook = default(WebhookModel), List<WebhookParameterValueModel> parameterValues = default(List<WebhookParameterValueModel>))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApplicationFeatureWebhookModel {\n");
        ...
        {
            return this.Equals(input as ApplicationFeatureWebhookModel);
        }

        /// <summary>
        /// Returns true if ApplicationFeatureWebhookModel instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationFeatureWebhookModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationFeatureWebhookModel input)
        {
            if (input == null)
                return false;
