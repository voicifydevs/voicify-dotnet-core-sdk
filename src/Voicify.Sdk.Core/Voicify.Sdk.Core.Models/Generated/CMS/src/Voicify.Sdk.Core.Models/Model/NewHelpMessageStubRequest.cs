...
{
    /// <summary>
    /// NewHelpMessageStubRequest
    /// </summary>
    [DataContract]
    public partial class NewHelpMessageStubRequest :  IEquatable<NewHelpMessageStubRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewHelpMessageStubRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewHelpMessageStubRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewHelpMessageStubRequest" /> class.
        /// </summary>
        ...
        public NewHelpMessageStubRequest(string content = default(string), string title = default(string), string applicationId = default(string), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string applicationFeatureId = default(string), string followUpId = default(string), string repromptId = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), bool? requiresParent = default(bool?), List<string> languageIds = default(List<string>))
        {
            ...
            {
                throw new InvalidDataException("applicationFeatureId is a required property for NewHelpMessageStubRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewHelpMessageStubRequest {\n");
        ...
        {
            return this.Equals(input as NewHelpMessageStubRequest);
        }

        /// <summary>
        /// Returns true if NewHelpMessageStubRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NewHelpMessageStubRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewHelpMessageStubRequest input)
        {
            if (input == null)
                return false;
