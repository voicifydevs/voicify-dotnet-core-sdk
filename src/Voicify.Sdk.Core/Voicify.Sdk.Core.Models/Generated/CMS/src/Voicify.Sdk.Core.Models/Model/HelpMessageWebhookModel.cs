...
{
    /// <summary>
    /// HelpMessageWebhookModel
    /// </summary>
    [DataContract]
        public partial class HelpMessageWebhookModel :  IEquatable<HelpMessageWebhookModel>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HelpMessageWebhookModel" /> class.
        /// </summary>
        ...
        public HelpMessageWebhookModel(string id = default(string), string helpMessageId = default(string), WebhookModel webhook = default(WebhookModel), List<WebhookParameterValueModel> parameterValues = default(List<WebhookParameterValueModel>), int? priority = default(int?))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HelpMessageWebhookModel {\n");
        ...
        {
            return this.Equals(input as HelpMessageWebhookModel);
        }

        /// <summary>
        /// Returns true if HelpMessageWebhookModel instances are equal
        /// </summary>
        /// <param name="input">Instance of HelpMessageWebhookModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HelpMessageWebhookModel input)
        {
            if (input == null)
                return false;
