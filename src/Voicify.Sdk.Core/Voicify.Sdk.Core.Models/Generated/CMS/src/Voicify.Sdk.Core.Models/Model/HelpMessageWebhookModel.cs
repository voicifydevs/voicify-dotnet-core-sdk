...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HelpMessageWebhookModel :  IEquatable<HelpMessageWebhookModel>, IValidatableObject
    {
        /// <summary>
        ...
        public HelpMessageWebhookModel(string id = default(string), string helpMessageId = default(string), WebhookModel webhook = default(WebhookModel), List<WebhookParameterValueModel> parameterValues = default(List<WebhookParameterValueModel>))
        {
            this.Id = id;
