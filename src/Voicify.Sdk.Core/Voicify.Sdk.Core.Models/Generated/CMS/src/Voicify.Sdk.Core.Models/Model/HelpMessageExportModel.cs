...
namespace Voicify.Sdk.Core.Models.Model
{
        ...
        public partial class HelpMessageExportModel :  IEquatable<HelpMessageExportModel>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HelpMessageExportModel {\n");
        ...
        {
            return this.Equals(input as HelpMessageExportModel);
        }

        /// <summary>
        /// Returns true if HelpMessageExportModel instances are equal
        /// </summary>
        /// <param name="input">Instance of HelpMessageExportModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HelpMessageExportModel input)
        {
            if (input == null)
                return false;
