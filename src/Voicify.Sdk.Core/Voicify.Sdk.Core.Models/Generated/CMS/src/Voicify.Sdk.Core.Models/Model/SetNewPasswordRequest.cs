...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SetNewPasswordRequest :  IEquatable<SetNewPasswordRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SetNewPasswordRequest" /> class.
        /// </summary>
        ...
        public SetNewPasswordRequest(string resetCode = default(string), string newPassword = default(string), string confirmNewPassword = default(string))
        {
            // to ensure "resetCode" is required (not null)
            if (resetCode == null)
            {
                throw new InvalidDataException("resetCode is a required property for SetNewPasswordRequest and cannot be null");
            }
            else
            {
            ...
            if (newPassword == null)
            {
                throw new InvalidDataException("newPassword is a required property for SetNewPasswordRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("confirmNewPassword is a required property for SetNewPasswordRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SetNewPasswordRequest {\n");
        ...
        {
            return this.Equals(input as SetNewPasswordRequest);
        }

        /// <summary>
        /// Returns true if SetNewPasswordRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SetNewPasswordRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SetNewPasswordRequest input)
        {
            if (input == null)
                return false;
