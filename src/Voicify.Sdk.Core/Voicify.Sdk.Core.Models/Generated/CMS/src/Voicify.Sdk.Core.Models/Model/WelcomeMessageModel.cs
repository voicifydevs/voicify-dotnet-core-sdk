...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class WelcomeMessageModel :  IEquatable<WelcomeMessageModel>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WelcomeMessageModel" /> class.
        /// </summary>
        ...
        public WelcomeMessageModel(string id = default(string), string applicationId = default(string), string applicationFeatureId = default(string), string title = default(string), bool? isLive = default(bool?), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), string content = default(string), MediaItemModel smallImage = default(MediaItemModel), MediaItemModel largeImage = default(MediaItemModel), MediaItemModel backgroundImage = default(MediaItemModel), MediaItemModel audio = default(MediaItemModel), MediaItemModel video = default(MediaItemModel), List<WelcomeMessageWebhookModel> welcomeMessageWebhooks = default(List<WelcomeMessageWebhookModel>), MediaResponseContainerModel mediaResponseContainer = default(MediaResponseContainerModel), FollowUpModel followUp = default(FollowUpModel), int? hits = default(int?), RepromptModel reprompt = default(RepromptModel), string repromptId = default(string), string followUpId = default(string), DateTime? createdDate = default(DateTime?), DateTime? modifiedDate = default(DateTime?), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), bool? requiresParent = default(bool?), bool? isComplete = default(bool?), string createdFromId = default(string), List<LanguageModel> languages = default(List<LanguageModel>), bool? shouldNotSync = default(bool?), string responseId = default(string), List<WelcomeMessageResponseModel> responses = default(List<WelcomeMessageResponseModel>), List<ConditionInstanceModel> conditions = default(List<ConditionInstanceModel>), WebhookChainingType? webhookChainingType = default(WebhookChainingType?), string appliedApplicationTemplateFormId = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WelcomeMessageModel {\n");
        ...
        {
            return this.Equals(input as WelcomeMessageModel);
        }

        /// <summary>
        /// Returns true if WelcomeMessageModel instances are equal
        /// </summary>
        /// <param name="input">Instance of WelcomeMessageModel to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WelcomeMessageModel input)
        {
            if (input == null)
                return false;
