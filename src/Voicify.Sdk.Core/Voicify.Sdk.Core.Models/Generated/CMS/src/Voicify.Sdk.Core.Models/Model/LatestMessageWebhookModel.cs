...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LatestMessageWebhookModel :  IEquatable<LatestMessageWebhookModel>, IValidatableObject
    {
        /// <summary>
        ...
        public LatestMessageWebhookModel(string id = default(string), string latestMessageId = default(string), WebhookModel webhook = default(WebhookModel), List<WebhookParameterValueModel> parameterValues = default(List<WebhookParameterValueModel>))
        {
            this.Id = id;
