...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    public partial class UpdateOrganizationRequest :  IEquatable<UpdateOrganizationRequest>
    {
        ...
        public UpdateOrganizationRequest(string name = default(string), string description = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for UpdateOrganizationRequest and cannot be null");
            }
            else
            {
                this.Name = name;
