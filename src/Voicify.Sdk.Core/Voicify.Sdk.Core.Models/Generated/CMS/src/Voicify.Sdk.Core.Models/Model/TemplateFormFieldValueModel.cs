...
namespace Voicify.Sdk.Core.Models.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemplateFormFieldValueModel :  IEquatable<TemplateFormFieldValueModel>, IValidatableObject
    {
        /// <summary>
        ...
        public TemplateFormFieldValueModel(string id = default(string), string templateFormFieldId = default(string), string value = default(string))
        {
            this.Id = id;
