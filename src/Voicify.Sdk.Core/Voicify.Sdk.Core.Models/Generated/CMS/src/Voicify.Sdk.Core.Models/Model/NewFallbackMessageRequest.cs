...
{
    /// <summary>
    /// NewFallbackMessageRequest
    /// </summary>
    [DataContract]
    public partial class NewFallbackMessageRequest :  IEquatable<NewFallbackMessageRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewFallbackMessageRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NewFallbackMessageRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewFallbackMessageRequest" /> class.
        /// </summary>
        ...
        public NewFallbackMessageRequest(string content = default(string), string title = default(string), string applicationId = default(string), string imageItemId = default(string), string backgroundImageItemId = default(string), string audioItemId = default(string), string videoItemId = default(string), string applicationFeatureId = default(string), string categoryId = default(string), string followUpId = default(string), string repromptId = default(string), string mediaResponseContainerId = default(string), string displayTextOverride = default(string), string displayTitleOverride = default(string), bool? requiresParent = default(bool?), List<string> languageIds = default(List<string>))
        {
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for NewFallbackMessageRequest and cannot be null");
            }
            else
            {
                this.Title = title;
            ...
            {
                throw new InvalidDataException("applicationFeatureId is a required property for NewFallbackMessageRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as NewFallbackMessageRequest);
        }

        /// <summary>
        /// Returns true if NewFallbackMessageRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NewFallbackMessageRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewFallbackMessageRequest input)
        {
            if (input == null)
                return false;
